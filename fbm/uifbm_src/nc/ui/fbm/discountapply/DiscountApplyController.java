 ...
 *
 */
public class DiscountApplyController extends AbstractManageController implements ISingleController{

	public static String BILLTYPE = FbmBusConstant.BILLTYPE_DISCOUNT_APP;
