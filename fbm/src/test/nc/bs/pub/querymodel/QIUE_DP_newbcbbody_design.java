...
public class QIUE_DP_newbcbbody_design	extends AbstractDataProcess {
	...
	public void process() throws Exception {
		...
		StorageDataSet ds = fbmreport.queryBcbBodyData(param,rep);
		String[] valuecol = new String[]{"moneyy","sxfmoneyy","discount_lx","register_securitymoneyy","accept_banksecmoneyy"};
