...
/**
 * 贴现推式生成收付报单据时的参照
 * DJZBheadVO.jsfsbm为36GG且系统来源为资金票据
 * @author xwq
 *
 */
public class Bill4DiscountEditRefModel extends AbstractTMRefModel {
	...
	public Bill4DiscountEditRefModel() {
		super();
	...
	private String getFilterString(){
		...
		sb.append(" and fbm_register.registerstatus = '" + FbmStatusConstant.HAS_DISCOUNT +"'");
		sb.append(" )");
		return sb.toString();
	}
