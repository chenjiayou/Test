...
/**
 * 托收推式生成收付报单据的票据编号参照
 * DJZBheadVO.jsfsbm为36GI且系统来源为资金票据
 * @author xwq
 *
 */
public class Bill4CollectionEditRefModel extends AbstractTMRefModel {
	...
	public Bill4CollectionEditRefModel() {
		super();
	...
	private String getFilterString(){
		...
		sb.append(" and fbm_register.registerstatus = '" + FbmStatusConstant.HAS_COLLECTION +"'");
		sb.append(" )");
		return sb.toString();
	}
	@Override
