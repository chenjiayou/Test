 ...
 * 
 */
public class InnerBackController extends AbstractManageController {

	public InnerBackController() {
	...
	public int[] getCardButtonAry() {
		...
		if (FBMClientInfo.isStartProcess().booleanValue()) {
			return new int[] { 
					...
					IFBMButton.InnerBack_LinkGroup, 
					IBillButton.Print,
					IBillButton.Return, };
		} else {
			return new int[] { 
	...
	public String getBillType() {
		// TODO Auto-generated method stub
		return FbmBusConstant.BILLTYPE_INNERBACK;
	}
