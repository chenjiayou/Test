...
public class CancelAuditInvoice<K extends RegisterVO,T extends RegisterVO> extends ActionInvoice<K,T> {
	...
	protected String doCheck(BusiActionParamVO<T> param) throws BusinessException {
		...
		if(!(actionVO.getActioncode().equals(FbmActionConstant.AUDIT)
			...
			return nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("fbmcomm","UPPFBMComm-000239")/* @res"票据"*/ + param.getBaseinfoVO().getFbmbillno() + nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("fbmcomm","UPPFBMComm-000267")/* @res"的前一操作必须是审核付票登记单。"*/+ BusiMessageTranslator.translateAction(param);
		}
		return null;
	}
