...
public class EndoreVoucher extends AbstractGeneralVoucher {
	...
	public void completeDapMsgVO(DapMsgVO dapvo, SuperVO supervo,
		...
		dapvo.setComment(nc.vo.ml.NCLangRes4VoTransl.getNCLangRes().getStrByID("3620add","UPP3620ADD-000141")/*@res "统管票据背书制证"*/);
