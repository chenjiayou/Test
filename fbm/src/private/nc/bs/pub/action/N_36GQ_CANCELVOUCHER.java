 ...
 * @author 平台脚本生成
 */
public class N_36GQ_CANCELVOUCHER extends AbstractCompiler2 {
private java.util.Hashtable m_methodReturnHas=new java.util.Hashtable();
private Hashtable m_keyHas=null;
/**
 * N_36GQ_CANCELVOUCHER 构造子注解。
 */
public N_36GQ_CANCELVOUCHER() {
	super();
}
/*
* 备注：平台编写规则类
...
try{
	...
	//制证操作
	Object retObj = new EndoreVoucher().voucher(vo.m_preValueVo, FbmBusConstant.OP_CANCELVOUCHER);
	
	EndoreVO endorevo = (EndoreVO)vo.m_preValueVo.getParentVO();

	endorevo.setUnitvoucher(new UFBoolean(false));
