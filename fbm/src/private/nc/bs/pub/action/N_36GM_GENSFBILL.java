 ...
 * @author 平台脚本生成
 */
public class N_36GM_GENSFBILL extends AbstractCompiler2 {
private java.util.Hashtable m_methodReturnHas=new java.util.Hashtable();
private Hashtable m_keyHas=null;
/**
 * N_36GM_GENSFBILL 构造子注解。
 */
public N_36GM_GENSFBILL() {
	super();
}
/*
 * 备注：平台编写规则类 接口执行类
 */
	public Object runComClass(PfParameterVO vo) throws BusinessException {
		try {
			...
			Object retObj = new InvoiceBillService().generateSFBill(vo.m_preValueVo);
			return retObj;
		} catch (Exception ex) {
