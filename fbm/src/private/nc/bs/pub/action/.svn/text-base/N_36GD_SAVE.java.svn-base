 ...
 * @author 平台脚本生成
 */
public class N_36GD_SAVE extends AbstractCompiler2 {
...
try{
	...
	if(!isNew){
		tmpVO = (HYBillVO)bo.queryBillVOByPrimaryKey(new String[] { HYBillVO.class.getName(),StorageVO.class.getName(), StorageBVO.class.getName() }, tmpVO.getParentVO().getPrimaryKey());
