 ...
 * @author 平台脚本生成
 */
public class N_36GK_VOUCHER extends AbstractCompiler2 {
private java.util.Hashtable m_methodReturnHas=new java.util.Hashtable();
private Hashtable m_keyHas=null;
/**
 * N_36GK_VOUCHER 构造子注解。
 */
public N_36GK_VOUCHER() {
	super();
}
/*
* 备注：平台编写规则类
...
try{
	...
	Object retObj= new RecieptService().operateVoucher(vo.m_preValueVo, loginCorp, FbmBusConstant.OP_VOUCHER);
	return retObj;
} catch (Exception ex) {
